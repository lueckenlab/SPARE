...
# Map severity to numeric values to calculate correlations. Critical > Severe
# on the WHO COVID-19 ordinal scale (ICU/ventilation > supplemental oxygen),
# so Critical takes the highest score.
