...
for layer, feature_name in [("X_pca", "PC"), ("X_scanvi_emb", "scanvi"), ("X_scpoli", "scpoli")]:
    ...
    try: 
        ...
        ).to_csv(f"../data/gloscope_input/hlca_{layer}.csv")
    except Exception as e:
        print("Failed", e)
...
).to_csv("../data/gloscope_input/hlca_samples.csv", index=False)
...
for cells_per_sample in (200, 500):
    ...
    print("Saving")
    adata_subset.write(f"../data/HLCA_{cells_per_sample}_cells_per_sample.h5ad")
